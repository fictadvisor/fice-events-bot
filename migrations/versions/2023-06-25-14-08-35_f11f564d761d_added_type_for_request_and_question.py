...
def upgrade() -> None:
    ...
    op.add_column('questions', sa.Column('type', request_types, nullable=False, server_default='FEEDBACK'))
    op.alter_column('questions', 'type', server_default=False)

    op.add_column('requests', sa.Column('type', request_types, nullable=False, server_default='FEEDBACK'))
    op.alter_column('questions', 'type', server_default=False)
